 ...
 */
function receiptzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['receiptzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('receiptzen sample setting'),
  '#default_value' => theme_get_setting('receiptzen_example'),
